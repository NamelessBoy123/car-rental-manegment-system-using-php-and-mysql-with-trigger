    ...
    <div class = "container">
        <div class="section-header">
            <div class="section-title">
                What Services we are offer to our clients....
            </div>
            <hr class="separator">
            <div class="section-tagline">
...
<section class = "our-brands" id = "brands">
    <div class = "container">
        <div class="section-header">
            <div class="section-title">
                First Class Car Rental & Limousine Services From Us
            </div>
            <hr class="separator">
            <div class="section-tagline">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class = "contact_info">
                        <li>
                            <i class="fas fa-map-marker-alt"></i>Pes university , Benglore karnataka
                        </li>
                        <li>
                            <i class="far fa-envelope"></i>pavankumarsindol@gmail.com
                        </li>
                        <li>
                            <i class="fas fa-mobile-alt"></i>+91 8495811023
                        </li>
                    </ul>
                </div>
            </div>
